...
extern "C" __global__ void __launch_bounds__(512) default_function_kernel0(float* __restrict__ data, float* __restrict__ kernel, float* __restrict__ conv_unpad, float* __restrict__ bias) {
  ...
  for (int ra_fused0_outer = 0; ra_fused0_outer < 19; ++ra_fused0_outer) {
    __syncthreads();
    data_pad_shared[((int)threadIdx.x)] = data[(((((((((int)blockIdx.x) / 49) * 158700) + ((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) / 49) * 52900)) + (((((((int)blockIdx.x) % 49) * 16) + ((((int)threadIdx.x) & 255) >> 4)) / 7) * 460)) + (((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) % 49) / 7) * 230)) + ((((((int)blockIdx.x) * 32) + (((int)threadIdx.x) & 255)) % 112) * 2)) + (((((int)threadIdx.x) >> 8) + ra_fused0_outer) % 7))];
    data_pad_shared[(((int)threadIdx.x) + 512)] = ((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) < 145) ? data[(((((((((int)blockIdx.x) / 49) * 158700) + (((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) + 2) / 49) * 52900)) + (((((((int)blockIdx.x) % 49) * 16) + ((((int)threadIdx.x) & 255) >> 4)) / 7) * 460)) + ((((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) + 2) % 49) / 7) * 230)) + ((((((int)blockIdx.x) * 32) + (((int)threadIdx.x) & 255)) % 112) * 2)) + ((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) + 2) % 7))] : 0.000000e+00f);
    data_pad_shared[(((int)threadIdx.x) + 1024)] = ((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) < 143) ? data[(((((((((int)blockIdx.x) / 49) * 158700) + (((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) + 4) / 49) * 52900)) + (((((((int)blockIdx.x) % 49) * 16) + ((((int)threadIdx.x) & 255) >> 4)) / 7) * 460)) + ((((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) + 4) % 49) / 7) * 230)) + ((((((int)blockIdx.x) * 32) + (((int)threadIdx.x) & 255)) % 112) * 2)) + ((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) + 4) % 7))] : 0.000000e+00f);
    data_pad_shared[(((int)threadIdx.x) + 1536)] = ((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) < 141) ? data[(((((((((int)blockIdx.x) / 49) * 158700) + (((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) + 6) / 49) * 52900)) + (((((((int)blockIdx.x) % 49) * 16) + ((((int)threadIdx.x) & 255) >> 4)) / 7) * 460)) + ((((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) + 6) % 49) / 7) * 230)) + ((((((int)blockIdx.x) * 32) + (((int)threadIdx.x) & 255)) % 112) * 2)) + ((((ra_fused0_outer * 8) + (((int)threadIdx.x) >> 8)) + 6) % 7))] : 0.000000e+00f);
    ...
    for (int ra_fused0_inner_outer = 0; ra_fused0_inner_outer < 8; ++ra_fused0_inner_outer) {
      ...
      kernel_pad_shared_local[0] = kernel_pad_shared[(((((int)threadIdx.x) >> 6) * 8) + ra_fused0_inner_outer)];
      kernel_pad_shared_local[1] = kernel_pad_shared[((((((int)threadIdx.x) >> 6) * 8) + ra_fused0_inner_outer) + 64)];
      kernel_pad_shared_local[2] = kernel_pad_shared[((((((int)threadIdx.x) >> 6) * 8) + ra_fused0_inner_outer) + 128)];
      kernel_pad_shared_local[3] = kernel_pad_shared[((((((int)threadIdx.x) >> 6) * 8) + ra_fused0_inner_outer) + 192)];
      kernel_pad_shared_local[4] = kernel_pad_shared[((((((int)threadIdx.x) >> 6) * 8) + ra_fused0_inner_outer) + 256)];
      kernel_pad_shared_local[5] = kernel_pad_shared[((((((int)threadIdx.x) >> 6) * 8) + ra_fused0_inner_outer) + 320)];
      kernel_pad_shared_local[6] = kernel_pad_shared[((((((int)threadIdx.x) >> 6) * 8) + ra_fused0_inner_outer) + 384)];
      kernel_pad_shared_local[7] = kernel_pad_shared[((((((int)threadIdx.x) >> 6) * 8) + ra_fused0_inner_outer) + 448)];
